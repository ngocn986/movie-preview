...
export default function TrendingNow() {
  ...
  const { handleTrendingNow, movieTrendByDay } = useContext(HomeContext);
  ...
  useEffect(() => {
    maxScrollWidth.current = carousel.current
      ...
      : 0;
  }, [maxScrollWidth, carousel]);
  return (
    <div className="carousel mx-28">
      <div className="relative overflow-hidden">
        <div className="font-Roboto flex items-center gap-5 text-2xl text-red-700  mx-10 mt-20">
          <span>Trending Now</span>
          <span>
            <Switch
              onClick={handleTrendingNow}
              checkedChildren={
                <span style={{ color: 'white', fontSize: '14px' }}>Week</span>
              }
              unCheckedChildren={
                <span style={{ color: 'white', fontSize: '14px' }}>Day</span>
              }
              style={{ backgroundColor: '#da3b1e' }}
            />
          </span>
        </div>
